function [f2,f_eq]=fun_position(fx,pose_ee)
...
f_eq1=sum(f_cable_vec,2)+M_ee*[0;0;gz]+fx(12)*unit_acce_vec;

f_eq2=sum(cross(r_ee_vec(1:3,:),f_cable_vec),2)+M_ee*cross(r_oc_G(1:3,1),[0;0;gz])+fx(12)*cross(r_oc_G(1:3,1),unit_acce_vec);
