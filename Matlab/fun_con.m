function [f2,f_eq]=fun_con(fx,pose_ee,acce_ee,~)
...
% f_eq3=norm(bp(:,1)-T_trans*ep(:,1))-fx(4)- fx(8)*fx(4)/(9.62*E);
% f_eq4=norm(bp(:,2)-T_trans*ep(:,2))-fx(5)- fx(9)*fx(5)/(9.62*E);
% f_eq5=norm(bp(:,3)-T_trans*ep(:,3))-fx(6)- fx(10)*fx(6)/(9.62*E);
% f_eq6=norm(bp(:,4)-T_trans*ep(:,4))-fx(7)- fx(11)*fx(7)/(9.62*E);
% 
